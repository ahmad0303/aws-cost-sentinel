...
class SlackNotifier:
    ...
    def __init__(self, config=None):
        ...
        self.mention_on_critical = self.config.get(
            "notifications.slack.mention_on_critical", "@channel"
        )
    ...
    def send_cost_alert(
        ...
        blocks = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": f"{emoji} AWS Cost Alert"},
            },
            {
                "type": "section",
                "fields": [
    ...
    def send_daily_summary(self, summary: Dict) -> bool:
        ...
        blocks = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📊 AWS Daily Cost Summary"},
            },
            {
                "type": "section",
                "fields": [
