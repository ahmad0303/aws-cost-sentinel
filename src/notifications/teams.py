...
class TeamsNotifier:
    ...
    def send_cost_alert(self, alert_type: str, cost: float, threshold: float, details: Dict) -> bool:
        ...
        try:
            ...
            section.addFact("Percent of Budget", f"{details.get('percent_of_budget', 0):.1f}%")
